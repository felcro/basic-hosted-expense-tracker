...
export const calendarStyle = tva({
  base: 'w-full web:max-w-xs bg-background border border-border rounded-lg p-4 gap-2',
  variants: {
    size: {
      sm: 'p-2 gap-2',
      md: 'p-2 gap-1',
...
export const calendarDayStyle = tva({
  base: 'flex-1 aspect-square items-center justify-center rounded-md web:max-w-[2.5rem] relative transition-colors',
  variants: {
    state: {
      'default': 'hover:bg-accent/10 active:bg-accent/80',
      'selected': 'bg-primary hover:bg-primary/80 active:bg-primary/80',
      'today': 'bg-accent/10',
